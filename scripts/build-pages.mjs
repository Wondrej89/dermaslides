...
<header class="site-header"><div class="header-inner"><a class="brand" href="../">Dermatopatologický atlas</a><button class="nav-toggle" type="button" aria-expanded="false" aria-controls="site-nav">Kategorie</button><nav class="site-nav" id="site-nav" aria-label="Hlavní navigace">${nav}<a href="#search">Vyhledávání</a></nav></div></header>
...
<section class="category-tools" id="search" aria-labelledby="search-title"><h2 id="search-title">Vyhledávání v atlasu</h2><div class="search-wrap"><label class="search-label" for="global-search">Diagnóza nebo klinický údaj</label><input class="search-input" id="global-search" type="search" autocomplete="off" placeholder="Hledat česky nebo anglicky" aria-controls="search-results" aria-expanded="false"><div class="search-results" id="search-results" role="region" aria-live="polite" hidden></div></div><h2>Abecední rejstřík</h2><div id="category-alphabet"></div></section>
